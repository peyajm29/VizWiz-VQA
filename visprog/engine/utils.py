...
class ProgramInterpreter:
    ...
    def execute(self,prog,init_state,inspect=False):
        ...
        print('\n\nHere are prog_steps: ', prog_steps, '\n\n')

        html_str = '<hr>'
        for prog_step in prog_steps:
            print('\n\nHere is the prog_step: ', prog_step, '\n\n')
            if inspect:
...
class ProgramGenerator():
    ...
    def generate(self, inputs):
        # print("Here are inputs: ", inputs)
        # print('Here is prompter + inputs: ',self.prompter(inputs))
    ...
    # def generate(self,inputs):
    #     print('\n\nHere are the inputs being passed ', self.prompter(inputs), '\n\n')
    ...
    #                     {
    #                         "type": "text",
    #                         "text": "You are writing code to understand and segment images to answer a visual question. You will be given 3 program examples by the user. Use the same naming conventions for the variables in the code."
    #                     }
    #                 ]
    #             }
    #         ],
